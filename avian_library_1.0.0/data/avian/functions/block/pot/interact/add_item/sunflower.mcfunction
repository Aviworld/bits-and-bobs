...
execute at @e[tag=avian.block.pot,sort=nearest,limit=1] run particle minecraft:effect ~ ~1 ~ 0.25 0 0.25 0 10
execute as @e[tag=avian.block.pot,sort=nearest,limit=1] run tag @s add avian.block.pot.ingredient.sunflower
