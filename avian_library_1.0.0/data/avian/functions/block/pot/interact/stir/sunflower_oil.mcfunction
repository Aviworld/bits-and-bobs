...
execute as @e[tag=avian.block.pot,sort=nearest,limit=1] run tag @s add avian.block.pot.fluid.sunflower_oil
execute as @e[tag=avian.block.pot,sort=nearest,limit=1] run item replace entity @s armor.head with minecraft:jigsaw{CustomModelData:7130204}